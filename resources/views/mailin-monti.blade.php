    ...
    <main>
        ...
        <section class="max-w-7xl mx-auto px-4 md:px-8 pt-8 md:pt-16 pb-16 md:pb-24 grid md:grid-cols-2 gap-12 items-center">
            <div class="order-2 md:order-1 flex flex-col items-center text-center md:items-start md:text-left">
                <span class="text-xs font-bold tracking-widest text-gray-500 uppercase mb-4 block">Especialistas en la salud de tu piel</span>
            ...
            <div class="order-1 md:order-2 relative flex justify-center md:justify-end">
                ...
                <div class="relative w-full max-w-lg aspect-square object-cover bg-gray-200">
                    <img src="{{ web_image('mailin.hero') }}" alt="Dra. Mailín Monti" class="w-full h-full object-cover">
                </div>
            </div>
        </section>
